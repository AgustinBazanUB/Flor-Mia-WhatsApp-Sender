...
export const ERROR_CODES = {
  ...
  whatsappUiChanged: "WHATSAPP_UI_CHANGED",
  selectorStrategyExhausted: "SELECTOR_STRATEGY_EXHAUSTED",
  preflightFailed: "PREFLIGHT_FAILED",
  contactLabelsNotFound: "LABELS_NOT_FOUND",
  ...
  contactExportFailed: "EXPORT_FAILED",
  contactExportCancelled: "CONTACT_EXPORT_CANCELLED",
