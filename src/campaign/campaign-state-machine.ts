...
const transitions: Record<CampaignStatus, ReadonlySet<CampaignStatus>> = {
  ...
  paused: new Set(["ready", "running", "stopped", "error", "images_required", "daily_limit_reached", "completed"]),
  waiting_contact: new Set(["running", "pause_requested", "paused", "daily_limit_reached", "stopped", "completed", "error"]),
  waiting_batch: new Set(["running", "pause_requested", "paused", "daily_limit_reached", "stopped", "completed", "error"]),
